      ...
      <div className="mt-10 bg-blue-800 text-white h-[10rem]">
        <div className="flex justify-between relative top-10">
          <div className="ml-20 relative top-[-0.6rem]">
            <span className="text-red-800 text-4xl">e</span>
            <span className="text-4xl">tranzact</span>
          </div>
          <div className="space-x-10">
            <Link to="/transaction"
              onClick={() => handleClick('/transaction')}
              className={`${currentPath === '/transaction' ? 'underline' : ''} underline-offset-4 hover:underline decoration-blue-500 decoration-4 px-2 font-semibold text-lg`}
            >
              Transaction
            </Link>
            <Link to="/feePay"
              onClick={() => handleClick('/feePay')}
              className={`${currentPath === '/feePay' ? 'underline' : ''} underline-offset-4 hover:underline decoration-blue-500 decoration-4 px-2 font-semibold text-lg`}
            >
              Fee payment
            </Link>
          </div>
